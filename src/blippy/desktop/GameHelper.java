...
public class GameHelper
{
     ...
     * NOT YET IMPLEMENTED!!!
     *
     * this is the timer to "click" if the user doesn't after 5 seconds
     */
    ...
    public GameHelper(Blippy pBlippy, Game pGame)
    {
        ...
        mClick = new EventHandler<ActionEvent>()
        {
    ...
    private void setupClickTimer()
    {
        ...
        KeyFrame keyFrame = new KeyFrame(duration, mClick,
                                         (KeyValue[]) null);
    ...
    private void click()
    {
        ...
        mResults[mCountChanges - 1] = ((double) mEndTime - mStartTime)
                                      / 1000000000;
        mStartTime = 0;
        mEndTime = 0;
        // Set up handler
